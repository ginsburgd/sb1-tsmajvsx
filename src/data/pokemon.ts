...
'Amnesia': { type: 'Psychic', category: 'Status', power: 0, accuracy: 100 },
'Ancient Power': { type: 'Rock', category: 'Special', power: 60, accuracy: 100 },
'Barrier': { type: 'Psychic', category: 'Status', power: 0, accuracy: 100 },
'Bulk Up': { type: 'Fighting', category: 'Status', power: 0, accuracy: 100 },
'Calm Mind': { type: 'Psychic', category: 'Status', power: 0, accuracy: 100 },
'Confusion': { type: 'Psychic', category: 'Special', power: 50, accuracy: 100 },
'Curse': { type: 'Ghost', category: 'Status', power: 0, accuracy: 100 },
'Defense Curl': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
...
'Encore': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
...
'Flame Wheel': { type: 'Fire', category: 'Physical', power: 60, accuracy: 100 },
'Focus Energy': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
'Growl': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
'Harden': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
...
'Light Screen': { type: 'Psychic', category: 'Status', power: 0, accuracy: 100 },
'Lovely Kiss': { type: 'Normal', category: 'Status', power: 0, accuracy: 75 },
'Low Kick': { type: 'Fighting', category: 'Physical', power: 50, accuracy: 100 },
'Low Sweep': { type: 'Fighting', category: 'Physical', power: 65, accuracy: 100 },
'Minimize': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
'Quick Attack': { type: 'Normal', category: 'Physical', power: 40, accuracy: 100 },
'Recover': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
'Rest': { type: 'Psychic', category: 'Status', power: 0, accuracy: 100 },
'Rock Throw': { type: 'Rock', category: 'Physical', power: 50, accuracy: 90 },
'Sand Attack': { type: 'Ground', category: 'Status', power: 0, accuracy: 100 },
'Scratch': { type: 'Normal', category: 'Physical', power: 40, accuracy: 100 },
'Shadow Punch': { type: 'Ghost', category: 'Physical', power: 60, accuracy: null },
'Slack Off': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
'Soft-Boiled': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
'Steel Wing': { type: 'Steel', category: 'Physical', power: 70, accuracy: 90 },
'Stomp': { type: 'Normal', category: 'Physical', power: 65, accuracy: 100 },
'Submission': { type: 'Fighting', category: 'Physical', power: 80, accuracy: 80 },
'Tail Whip': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
'Thunder': { type: 'Electric', category: 'Special', power: 110, accuracy: 70 },
'Water Gun': { type: 'Water', category: 'Special', power: 40, accuracy: 100 },
'Wing Attack': { type: 'Flying', category: 'Physical', power: 60, accuracy: 100 },
'Yawn': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Thunderbolt': { type: 'Electric', category: 'Special', power: 90, accuracy: 100 },
  'Explosion': { type: 'Normal', category: 'Physical', power: 250, accuracy: 100 },
  'Light Screen': { type: 'Psychic', category: 'Status', power: 0, accuracy: 100 },
  'Protect': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Psychic': { type: 'Psychic', category: 'Special', power: 90, accuracy: 100 },
  'Leech Seed': { type: 'Grass', category: 'Status', power: 0, accuracy: 90 },
  'Sleep Powder': { type: 'Grass', category: 'Status', power: 0, accuracy: 75 },
  'Solar Beam': { type: 'Grass', category: 'Special', power: 120, accuracy: 100 },
  'Bone Club': { type: 'Ground', category: 'Physical', power: 65, accuracy: 85 },
  'Earthquake': { type: 'Ground', category: 'Physical', power: 100, accuracy: 100 },
  'Double-Edge': { type: 'Normal', category: 'Physical', power: 120, accuracy: 100 },
  'Bonemerang': { type: 'Ground', category: 'Physical', power: 50, accuracy: 90 },
  ...
  'Counter': { type: 'Fighting', category: 'Physical', power: 0, accuracy: 100 },
  'Sky Uppercut': { type: 'Fighting', category: 'Physical', power: 85, accuracy: 90 },
  ...
  'Swords Dance': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Sludge Bomb': { type: 'Poison', category: 'Special', power: 90, accuracy: 100 },
  'Haze': { type: 'Ice', category: 'Status', power: 0, accuracy: 100 },
  'Will-O-Wisp': { type: 'Fire', category: 'Status', power: 0, accuracy: 85 },
  'Rock Blast': { type: 'Rock', category: 'Physical', power: 25, accuracy: 90 },
  ...
  'Soft-Boiled': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Thunder Wave': { type: 'Electric', category: 'Status', power: 0, accuracy: 90 },
  'Seismic Toss': { type: 'Fighting', category: 'Physical', power: 0, accuracy: 100 },
  'Giga Drain': { type: 'Grass', category: 'Special', power: 75, accuracy: 100 },
  'Stun Spore': { type: 'Grass', category: 'Status', power: 0, accuracy: 75 },
  'Substitute': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Surf': { type: 'Water', category: 'Special', power: 90, accuracy: 100 },
  'Smokescreen': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Ice Beam': { type: 'Ice', category: 'Special', power: 90, accuracy: 100 },
  'Agility': { type: 'Psychic', category: 'Status', power: 0, accuracy: 100 },
  'Waterfall': { type: 'Water', category: 'Physical', power: 80, accuracy: 100 },
  'Horn Drill': { type: 'Normal', category: 'Physical', power: 0, accuracy: 30 },
  'Recover': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Tri Attack': { type: 'Normal', category: 'Special', power: 80, accuracy: 100 },
  'Confuse Ray': { type: 'Ghost', category: 'Status', power: 0, accuracy: 100 },
  'Night Shade': { type: 'Ghost', category: 'Special', power: 0, accuracy: 100 },
  'Shadow Ball': { type: 'Ghost', category: 'Special', power: 80, accuracy: 100 },
  'Hypnosis': { type: 'Psychic', category: 'Status', power: 0, accuracy: 60 },
  'Dream Eater': { type: 'Psychic', category: 'Special', power: 100, accuracy: 100 },
  'Disable': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Flash': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Crabhammer': { type: 'Water', category: 'Physical', power: 100, accuracy: 90 },
  'Clamp': { type: 'Water', category: 'Physical', power: 35, accuracy: 85 },
  'Acid Armor': { type: 'Poison', category: 'Status', power: 0, accuracy: 100 },
  'Transform': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Rest': { type: 'Psychic', category: 'Status', power: 0, accuracy: 100 },
  'Outrage': { type: 'Dragon', category: 'Physical', power: 120, accuracy: 100 },
  'Roost': { type: 'Flying', category: 'Status', power: 0, accuracy: 100 },
  ...
  'Splash': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'Flail': { type: 'Normal', category: 'Physical', power: 0, accuracy: 100 },
  'Dragon Dance': { type: 'Dragon', category: 'Status', power: 0, accuracy: 100 },
  'Bite': { type: 'Dark', category: 'Physical', power: 60, accuracy: 100 },
  'Crunch': { type: 'Dark', category: 'Physical', power: 80, accuracy: 100 },
  'Sky Attack': { type: 'Flying', category: 'Physical', power: 140, accuracy: 90 },
  ...
  'Focus Punch': { type: 'Fighting', category: 'Physical', power: 150, accuracy: 100 },
  'Teleport': { type: 'Psychic', category: 'Status', power: 0, accuracy: 100 },
  'Roar': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 },
  'X-Scissor': { type: 'Bug', category: 'Physical', power: 80, accuracy: 100 },
  'Knock Off': { type: 'Dark', category: 'Physical', power: 65, accuracy: 100 },
  'Double Team': { type: 'Normal', category: 'Status', power: 0, accuracy: 100 }
};
